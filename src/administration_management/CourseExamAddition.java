...
public class CourseExamAddition implements ICourseAddition {
    ...
    public CourseExamAddition(String courseName, String examname, String question, String option_1, String option_2, int correct_option)
    {
    ...
    public void adding() throws SQLException {
        try {
            ...
            String sqlinsertQuiz = "INSERT INTO exams (coursename, examname,question,choice1,choice2,answer) VALUES ((SELECT course_name FROM courses WHERE course_name=?), ?,?,?,?,?)";
            PreparedStatement insertquiz = conn.prepareStatement(sqlinsertQuiz);
            insertquiz.setString(1, courseName);
            insertquiz.setString(2, examname);
